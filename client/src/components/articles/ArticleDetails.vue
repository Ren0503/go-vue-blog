...
<script>
import { ArticleService } from "@/services/apis/articleService";
import { UsersService } from "@/services/base/usersService";
import { CommentsService } from "@/services/apis/commentService";
...
export default {
    ...
    methods: {
        ...
        fetchBySlug(slug) {
            ArticleService.fetchBySlug(slug)
                .then(result => {
                    if (result.success) {
                        this.article = {...result};
        ...
        postComment() {
            ...
            CommentsService.create(slug, this.commentData).then(res => {
                if (res.success) {
