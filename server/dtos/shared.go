...
func GetErrorDto(message string) interface{} {
	return gin.H{
		"success":       false,
...
func GetSuccessDto(message string) interface{} {
	return GetSuccessWithMessagesDto([]string{message})
}
...
func GetSuccessWithMessagesDto(messages []string) interface{} {
	return gin.H{
		"success":       true,
		"full_messages": messages,
	}
